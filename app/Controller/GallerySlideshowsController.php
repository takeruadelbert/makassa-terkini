...
class GallerySlideshowsController extends AppController {
    ...
    function beforeFilter() {
        parent::beforeFilter();
        $this->_setPageInfo("admin_index", "Gallery Slideshow");
        $this->_setPageInfo("admin_add", "Tambah Gallery Slideshow");
        $this->_setPageInfo("admin_edit", "Ubah Gallery Slideshow");
        $this->_setPageInfo("admin_edit", "Lihat Gallery Slideshow");
    }
    ...
    function admin_add() {
        ...
        $this->set("newsCategories", $this->{ Inflector::classify($this->name) }->GallerySlideshowDetail->News->NewsCategory->find("list", array("fields" => array("NewsCategory.id", "NewsCategory.name"))));
        ...
        if ($this->request->is("post") || $this->request->is("put")) {
            ...
            if ($this->{ Inflector::classify($this->name) }->validates()) {
                if (!is_null($id)) {
                    ...
                    $this->GallerySlideshow->data['GallerySlideshow']['id'] = $id;
    ...
    function admin_view($id = null) {
        if (!$this->GallerySlideshow->exists($id)) {
