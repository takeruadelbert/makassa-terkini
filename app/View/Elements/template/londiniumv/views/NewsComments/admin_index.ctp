<?php
echo $this->element(_TEMPLATE_DIR . "/{$template}/filter/news-comment");
?>
<div class="panel panel-default">
    <div class="panel-body">
        <div class="block-inner text-danger">
            <h6 class="heading-hr"><?= __("DATA KOMENTAR")?>
                    ...
                    <tbody>
                        ...
                        foreach ($data['rows'] as $item) {
                            ...
                            <tr id="row-<?= $i ?>" class="removeRow<?php echo $item[Inflector::classify($this->params['controller'])]['id']; ?>">
                                ...
                                <td><?= $item['NewsComment']['comentator_name'] ?></td>
                                <td><?= $this->Echo->empty_strip($item['NewsComment']['comment']) ?></td>
