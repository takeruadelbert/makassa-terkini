<?php echo $this->Form->create("Event", array("class" => "form-horizontal form-separate", "type"=>"file", "action" => "edit", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="block-inner text-danger">
                    <h6 class="heading-hr"><?= __("Ubah Event") ?>
                    </h6>
                </div>
                            ...
                            <div class="block-row qq-upload-list" id="file-uploader-content-list">
                                ...
                                foreach ($this->data['EventImage'] as $eventImage) {
                                    ...
                                    <div class="row row-table row-remove-<?php echo $i ?> qq-upload-success">
                                        <div class="col-md-3"><img src="<?php echo Router::url($eventImage['path']) ?>" width="100"></div>
                                        <div class="col-md-3"><input value="<?php echo $eventImage['description'] ?>" class="form-control" type="text" maxlength="50" name="data[EventImage][<?php echo $i ?>][description]"></div>
                                        <div class="col-md-3">
                                            <input <?php echo $eventImage['default_image'] ? "checked" : "" ?> value="<?php echo $eventImage['default_image'] ?>" class="gallery_photo_default" type="checkbox" name=""/>
                                            <input <?php echo $eventImage['default_image'] ? "checked" : "" ?> value="<?php echo $eventImage['default_image'] ?>" class="gallery_photo_default" type="hidden" name="data[EventImage][<?php echo $i ?>][default_image]"/>
                                        </div>
                                        ...
                                        <div class="col-md-3"><a class="" onclick="hapusGambar(<?php echo $eventImage['id'] ?>, '<?php echo Router::url("/admin/eventImages/delete/") ?>', <?php echo $i ?>);">Hapus</a><span class="qq-upload-failed-text" style="color: red">Gagal</span></div>
                                    </div>
                                    <?php
                                    $i++;
                                }
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                echo $this->Form->input("Event.country_id", array("div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control", "empty" => "-- Pilih Negara --"));
                                                ?>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                echo $this->Form->input("Event.state_id", array("div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control", "empty" => "- Pilih Provinsi -"));
                                                ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                echo $this->Form->input("Event.city_id", array("empty" => "- Pilih Kota -", "div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control"));
                                                ?>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="checkbox-inline checkbox-success">
                                                    ...
                                                    ?>
                                                    <input type="checkbox" class="styled" name="data[Event][is_sponsor]" value='<?= $checked == "" ? "0" : "1" ?>' id="eventSponsor" <?= $checked ?>>
...
<script>
    $(document).ready(function () {
        $('#eventSponsor').change(function () {
            if ($('#eventSponsor').is(':checked')) {
                $('#eventSponsorHidden2').attr("disabled", true);
                $('#eventSponsorHidden1').removeAttr("disabled");
            } else {
                $('#eventSponsorHidden1').attr("disabled", true);
                $('#eventSponsorHidden2').removeAttr("disabled");
            }
        });
    });
</script>
