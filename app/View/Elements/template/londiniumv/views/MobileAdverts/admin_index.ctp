<?php
echo $this->element(_TEMPLATE_DIR . "/{$template}/filter/mobile-advert");
?>
<div class="panel panel-default">
    <div class="panel-body">
        <div class="block-inner text-danger">
            <h6 class="heading-hr"><?= __("DATA IKLAN BERITA MOBILE")?>
                    ...
                    <tbody>
                        ...
                        foreach ($data['rows'] as $item) {
                            ...
                            <tr id="row-<?= $i ?>" class="removeRow<?php echo $item[Inflector::classify($this->params['controller'])]['id']; ?>">
                                ...
                                <td class="text-center"><img src="<?= str_replace('\\', '/', Router::url("{$item['MobileAdvert']['path']}", true)) ?>" width="200" height="80"></td>
                                <td class="text-center">980 x 280</td>
