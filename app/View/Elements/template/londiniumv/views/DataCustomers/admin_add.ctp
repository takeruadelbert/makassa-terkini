<?php echo $this->Form->create("DataCustomer", array("class" => "form-horizontal form-separate", "action" => "add", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="row">
    <div class="col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2">
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="block-inner text-danger">
                    <h6 class="heading-hr"><?= __("Tambah Data Pelanggan") ?>
                    </h6>
                </div>
                        ...
                        <tr>
                            <td colspan="3" style="width:200px">
                                <div class="form-group">
                                    ...
                                    echo $this->Form->input("DataCustomer.country_id", array("div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control", "empty" => "-- Pilih Negara --"));
                                    ?>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="3" style="width:200px">
                                <div class="form-group">
                                    ...
                                    echo $this->Form->input("DataCustomer.phone", array("onkeydown" => "return (event.which >= 48 && event.which <= 57) || event.which == 8 || event.which == 46;", "div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control field-nomorOrder"));
                                    ?>
                                </div>
                            </td>
                        </tr>
