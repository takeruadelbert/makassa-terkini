                    ...
                    <tbody>
                        ...
                        foreach ($data['rows'] as $item) {
                            ...
                            <tr id="row-<?= $i ?>" class="removeRow<?php echo $item[Inflector::classify($this->params['controller'])]['id']; ?>">
                                ...
                                <td class="text-center"><img src="<?= str_replace('\\', '/', Router::url("{$item['Advert']['path']}", true)) ?>" width="200" height="80"></td>
                                <td class="text-center"><?= $item['AdvertType']['name'] ?></td>
                                <td class="text-center"><?= $item['AdvertPosition']['name'] ?></td>
                                <td class="text-center"><?= emptyToStrip(@$item['DataCustomer']['name']) ?></td>
