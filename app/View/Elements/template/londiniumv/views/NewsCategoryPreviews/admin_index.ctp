<?php
echo $this->element(_TEMPLATE_DIR . "/{$template}/filter/news-category-preview");
?>
<div class="panel panel-default">
    <div class="panel-body">
        <div class="block-inner text-danger">
            <h6 class="heading-hr"><?= __("DATA PREVIEW KATEOGIR BERITA")?>
                ...
                <table width="100%" class="table table-hover table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th width="50">No</th>
                            <th><?= __("Nama Preview Kategori Berita") ?></th>
                            <th><?= __("Status Preview Kategori Berita") ?></th>
                    ...
                    <tbody>
                        ...
                        foreach ($data['rows'] as $item) {
                            ...
                            <tr id="row-<?= $i ?>" class="removeRow<?php echo $item[Inflector::classify($this->params['controller'])]['id']; ?>">
                                ...
                                <td class="text-center"><?= $item['NewsCategoryPreview']['name'] ?></td>
