        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="block-inner text-danger">
                    <h6 class="heading-hr"><?= __("Ubah Berita Video") ?>
                    </h6>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <video id="video" src = "<?php echo Router::url($this->data['News']['video_path'], true) ?>" width="100"/></video>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <?php
                                                echo $this->Form->label("News.0.gambar", __("Thumbail Foto"), array("class" => "col-sm-3 col-md-4 control-label"));
