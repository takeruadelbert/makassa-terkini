        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="block-inner text-danger">
                    <h6 class="heading-hr"><?= __("Ubah Berita Foto") ?>
                    </h6>
                </div>
                                ...
                                <div class="block-row qq-upload-list" id="file-uploader-content-list">
                                    ...
                                    foreach ($this->data['NewsImage'] as $newsImage) {
                                        ...
                                        <div class="row row-table row-remove-<?php echo $i ?> qq-upload-success">
                                            ...
                                            <div class="col-md-3"><input value="<?php echo $newsImage['description'] ?>" class="form-control" type="text" maxlength="1000" name="data[NewsImage][<?php echo $i ?>][description]"></div>
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3"><a class="" onclick="hapusGambar(<?php echo $newsImage['id'] ?>, '<?php echo Router::url("/admin/newsImages/delete/") ?>', <?php echo $i ?>);">Hapus</a><span class="qq-upload-failed-text" style="color: red">Gagal</span></div>
                                        </div>
                                        <?php
                                        $i++;
                                    }
