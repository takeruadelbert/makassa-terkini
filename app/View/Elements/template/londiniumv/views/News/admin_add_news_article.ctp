<?php echo $this->Form->create("News", array("class" => "form-horizontal form-separate", "type" => "file", "action" => "add_news_article", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="block-inner text-danger">
                    <h6 class="heading-hr"><?= __("Tambah Berita Artikel") ?>
                    </h6>
                </div>
                                ...
                                <td colspan="3" style="width:200px">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <?php
                                                echo $this->Form->label("NewsImage.0.gambar", __("Thumbnail Foto"), array("class" => "col-sm-3 col-md-4 control-label"));
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <?php
                                                echo $this->Form->label("News.thumbnail_description", __("Deskripsi Foto"), array("class" => "col-sm-3 col-md-4 control-label"));
