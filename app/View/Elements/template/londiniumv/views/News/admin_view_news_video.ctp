<?php echo $this->Form->create("News", array("class" => "form-horizontal form-separate", "type" => "file", "action" => "edit_news_video", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="block-inner text-danger">
                    <h6 class="heading-hr"><?= __("Lihat Berita Video") ?>
                    </h6>
                </div>
                                    ...
                                    <table width="100%" class="table">
                                        <tr>
                                            <td colspan="3" style="width:200px">
                                                <div class="form-group">
                                                    <?php
                                                    echo $this->Form->label("News.title_ind", __("Judul Bahasa Indonesia"), array("class" => "col-sm-3 col-md-4 control-label"));
                                        ...
                                        <tr>
                                            <td colspan="3" style="width:200px">
                                                <div class="form-group">
                                                    <?php
                                                    echo $this->Form->label("News.sinopsys_ind", __("Sinopsis Bahasa Indonesia"), array("class" => "col-sm-8 control-label"));
                                        ...
                                        <tr>
                                            <td colspan="3" style="width:200px">
                                                <div class="form-group">
                                                    <?php
                                                    echo $this->Form->label("News.content_ind", __("Konten Bahasa Indonesia"), array("class" => "col-sm-8 control-label"));
                                    ...
                                    <table width="100%" class="table">
                                        <tr>
                                            <td colspan="3" style="width:200px">
                                                <div class="form-group">
                                                    <?php
                                                    echo $this->Form->label("News.title_en", __("Judul Bahasa Inggris"), array("class" => "col-sm-3 col-md-4 control-label"));
                                        ...
                                        <tr>
                                            <td colspan="3" style="width:200px">
                                                <div class="form-group">
                                                    <?php
                                                    echo $this->Form->label("News.sinopsys_en", __("Sinopsis Bahasa Inggris"), array("class" => "col-sm-8 control-label"));
                                        ...
                                        <tr>
                                            <td colspan="3" style="width:200px">
                                                <div class="form-group">
                                                    <?php
                                                    echo $this->Form->label("News.content_en", __("Konten Bahasa Inggris"), array("class" => "col-sm-8 control-label"));
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <video id="video" src = "<?php echo Router::url($this->data['News']['video_path'], true) ?>" type="file" width="100"/></video>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4"> </div>
                                                <div class="col-md-8">
                                                    <img id="video" src = "<?php echo Router::url($this->data['News']['thumbnail_path'], true) ?>" type="file" width="100"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                echo $this->Form->input("News.thumbnail_description", array("type" => "text", "div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control", "disabled"));
                                                ?>
                                            </div>
                                        </div>
                                    </div>
