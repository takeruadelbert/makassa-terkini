<?php echo $this->Form->create("GallerySlideshow", array("class" => "form-horizontal form-separate", "action" => "add", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="block-inner text-danger">
                    <h6 class="heading-hr"><?= __("Tambah Slideshow Galeri Foto") ?>
                    </h6>
                </div>
                    ...
                    <table width="100%" class="table">
				        ...
				        <div class="form-group">
                                            <div class="col-md-5">
                                                ...
                                                echo $this->Form->input("Dummy.0.news_category_id", array("div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control news-title-photo", "empty" => "-- Pilih Kategori Berita --", "data-news-title-photo-target" => ".news-title-photo-target"));
                                                ?>
                                            </div>
                                            <div class="col-md-5">
                                            ...
                                            <div class="col-md-2">
                                                <label class="checkbox-inline checkbox-success">
                                                    <input type="checkbox" name="data[GallerySlideshowDetail][0][is_primary]" value='1' onclick="addClassCheck(this)"> <b>Default Primary</b> &nbsp;
                                                </label>
                                            </div>
				        </div>
                                        <div class="form-group">
                                            <div class="col-md-5">
                                                ...
                                                echo $this->Form->input("Dummy.1.news_category_id", array("div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control news-title-photo2", "empty" => "-- Pilih Kategori Berita --", "data-news-title-photo2-target" => ".news-title-photo2-target"));
                                                ?>
                                            </div>
                                            <div class="col-md-5">
                                                <label class="col-sm-3 col-md-4 control-label">Judul Berita</label>
                                            ...
                                            <div class="col-md-2">
                                                <label class="checkbox-inline checkbox-success">
                                                    <input type="checkbox" name="data[GallerySlideshowDetail][1][is_primary]" value='1' onclick="addClassCheck(this)"> <b>Default Primary</b> &nbsp;
                                                </label>
                                            </div>
				        </div>
                                        <div class="form-group">
                                            <div class="col-md-5">
                                                ...
                                                echo $this->Form->input("Dummy.2.news_category_id", array("div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control news-title-photo3", "empty" => "-- Pilih Kategori Berita --", "data-news-title-photo3-target" => ".news-title-photo3-target"));
                                                ?>
                                            </div>
                                            <div class="col-md-5">
                                                <label class="col-sm-3 col-md-4 control-label">Judul Berita</label>
                                            ...
                                            <div class="col-md-2">
                                                <label class="checkbox-inline checkbox-success">
                                                    <input type="checkbox" name="data[GallerySlideshowDetail][2][is_primary]" value='1' onclick="addClassCheck(this)"> <b>Default Primary</b> &nbsp;
                                                </label>
                                            </div>
				        </div>
				    </div>
