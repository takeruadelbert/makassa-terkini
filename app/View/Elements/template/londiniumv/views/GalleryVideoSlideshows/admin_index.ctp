<?php
echo $this->element(_TEMPLATE_DIR . "/{$template}/filter/gallery-video-slide-show");
?>
<div class="panel panel-default">
    <div class="panel-body">
        <div class="block-inner text-danger">
            <h6 class="heading-hr"><?= __("DATA SLIDESHOW GALERI VIDEO")?>
                ...
                <table width="100%" class="table table-hover table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th width="50">No</th>
                            <th><?= __("Nama Slideshow") ?></th>
                            <th><?= __("Tipe Slideshow") ?></th>
                            <th><?= __("Status Slideshow") ?></th>
                    ...
                    <tbody>
                        ...
                        foreach ($data['rows'] as $item) {
                            ...
                            <tr id="row-<?= $i ?>" class="removeRow<?php echo $item[Inflector::classify($this->params['controller'])]['id']; ?>">
                                ...
                                <td class="text-center"><?= $item['GalleryVideoSlideshow']['name'] ?></td>
                                <td class="text-center"><?= $this->Echo->empty_strip($item['SlideshowType']['name']) ?></td>
