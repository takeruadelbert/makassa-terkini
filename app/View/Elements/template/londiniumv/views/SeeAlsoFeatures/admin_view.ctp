<?php echo $this->Form->create("SeeAlsoFeature", array("class" => "form-horizontal form-separate", "action" => "view", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="block-inner text-danger">
                    <h6 class="heading-hr"><?= __("Lihat Fitur Baca Juga") ?>
                    </h6>
                </div>
                    ...
                    <table width="100%" class="table">
                            ...
                            <td colspan="3" style="width:200px">
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        echo $this->Form->input("SeeAlsoFeature.name", array("div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control", "disabled"));
                                        ?>
                                    </div>
                                    <div class="col-md-6">
                                        <?php
                                        ...
                                        <div class="col-sm-9 col-md-8">
                                            <select class="form-control news-category" name="data[SeeAlsoFeature][parent_category]" data-news-subcategory-target=".news-subcategory,.news-subcategory2,.news-subcategory3" disabled>
				        ...
				        <div class="form-group">
                                            <div class="col-md-6">
                                                ...
                                                ?>
                                                <div class="col-sm-9 col-md-8">
                                                    <select class="form-control news-subcategory" data-news-title-target=".news-title-target"  disabled>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-sm-9 col-md-8">
                                                    <select class="form-control news-title-target" name="data[SeeAlsoFeatureDetail][0][news_id]" disabled>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6">
                                                ...
                                                ?>
                                                <div class="col-sm-9 col-md-8">
                                                    <select class="form-control news-subcategory" data-news-title2-target=".news-title2-target" disabled>
                                                        <option value="">-- Pilih Subkategori Berita --</option>
                                                        <?php
                                                        $subSelected2 = "";
                                            ...
                                            <div class="col-md-6">
                                                <label class="col-sm-3 col-md-4 control-label">Judul Berita</label>
                                                <div class="col-sm-9 col-md-8">
                                                    <select class="form-control news-title2-target" name="data[SeeAlsoFeatureDetail][1][news_id]" disabled>
                                                        <option value="">--Pilih Judul Berita--</option>
                                                        <?php
                                                        $selected2 = "";
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6">
                                                ...
                                                ?>
                                                <div class="col-sm-9 col-md-8">
                                                    <select class="form-control news-subcategory" data-news-title3-target=".news-title3-target" disabled>
                                                        <option value="">-- Pilih Subkategori Berita --</option>
                                                        <?php
                                                        $subSelected3 = "";
                                            ...
                                            <div class="col-md-6">
                                                <label class="col-sm-3 col-md-4 control-label">Judul Berita</label>
                                                <div class="col-sm-9 col-md-8">
                                                    <select class="form-control news-title3-target" name="data[SeeAlsoFeatureDetail][2][news_id]" disabled>
                                                        <option value="">--Pilih Judul Berita--</option>
                                                        <?php
                                                        $selected3 = "";
