                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    echo $this->Form->input("User.user_group_id", array("div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control", "empty" => "- Pilih Posisi -", "disabled"));
                                    ?>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    echo $this->Form->input("Biodata.identity_type_id", array("empty" => "- Pilih Jenis Identitas -", "div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control", "disabled"));
                                    ?>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    echo $this->Form->input("Biodata.gender_id", array("empty" => "- Pilih Jenis Kelamin -", "div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control", "disabled"));
                                    ?>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    echo $this->Form->input("Biodata.birth_date", array("type" => "text", "div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control datepicker", "disabled"));
                                    ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    echo $this->Form->input("Biodata.country_id", array("div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control", "disabled"));
                                    ?>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    echo $this->Form->input("Biodata.state_id", array("empty" => "- Pilih Provinsi -", "div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control city-state", "data-city-state-target" => ".city-state-target", "disabled"));
                                    ?>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 col-md-8">
                                        <select class="form-control city-state-target" name="data[Biodata][city_id]" disabled>
                                            <option>-- Pilih Kota --</option>
                                            <?php
                                            $isSelected = "";
                                            foreach($cityList as $cities) {
                                                if($cities['City']['id'] == $this->data['Biodata']['City']['id']) {
                                                    $isSelected = "selected";
                                                } else {
                                                    $isSelected = "";
                                                }
                                            ?>
                                            <option value="<?= $cities['City']['id'] ?>" <?= $isSelected ?>><?= $cities['CityStatus']['name'] . " " . $cities['City']['name'] ?></option>
                                            <?php
                                            }
                                            ?>
                                        </select>
