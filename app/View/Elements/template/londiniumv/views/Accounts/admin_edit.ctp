                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    echo $this->Form->input("User.id", array("input" => "hidden", "value" => $this->data['User']['id']));
                                    ?>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    echo $this->Form->input("Biodata.id", array("input" => "hidden", "value" => $this->data['Biodata']['id']));
                                    ?>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    echo $this->Form->input("Biodata.birth_date", array("type" => "text", "div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control datepicker"));
                                    ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    echo $this->Form->input("Biodata.state_id", array("empty" => "- Pilih Provinsi -", "div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control city-state", "data-city-state-target" => ".city-state-target"));
                                    ?>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 col-md-8">
                                        <select class="form-control city-state-target" name="data[Biodata][city_id]">
