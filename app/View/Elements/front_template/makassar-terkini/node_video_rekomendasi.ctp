        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 index-contentBack">
                <div class="news-head-bt">
                    <img src="<?= Router::url("/front_file/makassar-terkini/img/icon/video-rekomendasi.png", true) ?>" style="width: auto; height: 35px;">

                    <div class="redspan">
                        <div class="greyspan" style="width: 490px;">
                        </div>
                    </div>
                ...
                <div id="foto-populer-carousel" class="carousel slide" data-ride="carousel" style="height: inherit; position: relative;">
                    <div class="carousel-inner" role="listbox">
                        <div class="item active " style="text-align: justify;">
                            <?php
                            foreach ($recommendedVideoNews as $k => $recommendedNews) {
                                $recommended_video_news_title = seoUrl($recommendedNews['News']['title_ind']);
                                if ($k < 6) {
                                    ?>
                                    <div class="news-module-ver">
                                        <a href="<?= Router::url("/video/{$recommendedNews['News']['id']}/$recommended_video_news_title", true) ?>">
                                            <div class="news-module-ver-img">
                                                ...
                                                <span class="duration">
                                                    ...
                                                    $getid3 = new getID3;
                                                    $getid3->analyze(WWW_ROOT . ltrim(str_replace('\\', '/', $recommendedNews['News']['video_path']), "/"));
