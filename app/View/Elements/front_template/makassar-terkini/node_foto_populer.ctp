        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 index-contentBack">
                <div class="news-head-bt">
                    <img src="<?= Router::url("/front_file/makassar-terkini/img/icon/foto-populer.png", true) ?>" style="width: auto; height: 35px;">
                ...
                <div id="foto-populer-carousel" class="carousel slide" data-ride="carousel" style="height: inherit; position: relative;">
                    <div class="carousel-inner" role="listbox">
                        <div class="item active " style="text-align: justify;">
                            <?php
                            foreach($news_photo_popular as $k => $news_photo1) {
                                $news_photo1_title = seoUrl($news_photo1['News']['title_ind']);
                                if($k < 6) {
                            ?>
                            <div class="news-module-ver">                            
                                <div class="news-module-ver-img">
                                    <img src="<?= Router::url($news_photo1['News']['thumbnail_path'], true) ?>"></a>
                                </div>
                                <div class="news-module-ver-content font-sourceSansPro">
                                    <div class="news-module-ver-etc">
                                        <div class="news-module-ver-time pull-left">
                                            Telah dilihat <?= $news_photo1['News']['hits'] ?> kali
                                        </div>
                                    </div>

                                    <div class="news-module-ver-title edit-height-ver-title">
                                        <a href="<?= Router::url("/foto/{$news_photo1['News']['id']}/$news_photo1_title", true) ?>"> <?= $news_photo1['News']['title_ind'] ?> </a>
                                    </div>
                                </div>
                            </div>
                            <?php
                        ...
                        <div class="item" style="text-align: justify;">
                            <?php
                            foreach($news_photo_popular as $k => $news_photo2) {
                                $news_photo2_title = seoUrl($news_photo2['News']['title_ind']);
                                if($k > 5 && $k < 12) {
                            ?>
                            <div class="news-module-ver">                           
                                <div class="news-module-ver-img">
                                    <img src="<?= Router::url($news_photo2['News']['thumbnail_path'], true) ?>">
                                </div>
                                <div class="news-module-ver-content font-sourceSansPro">
                                    <div class="news-module-ver-etc">
                                        <div class="news-module-ver-time pull-left">
                                            Telah dilihat <?= $news_photo2['News']['hits'] ?> kali
                                        </div>
                                    </div>

                                    <div class="news-module-ver-title edit-height-ver-title">
                                        <a href="<?= Router::url("/foto/{$news_photo2['News']['id']}/$news_photo2_title", true) ?>"> <?= $news_photo2['News']['title_ind'] ?> </a>
                                    </div>
                                </div>
                            </div>
                            <?php
