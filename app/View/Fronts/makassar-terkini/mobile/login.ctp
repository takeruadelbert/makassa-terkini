        ...
        <div class="row section-color">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12 boxOut-loginTop boxOut-loginUp">
                    ...
                    <?php
                        echo $this->Form->create('Account', array('action' => 'mobile_login_member', 'type' => 'post')); 
                    ?>
                    <div class="row">
                            ...
                            <div class="row ">
                                <div class="col-md-12 col-sm-12 col-xs-12 boxOut-username">
                                    <div class="boxFieldUsername">
                                        <input type="text" class="form-control field-boxLeft font-openSans" placeholder="Email / Username" name="data[User][email]">
                                    </div>
                                    <div class="boxIconUsername center flex">
                                        <img src="<?= Router::url("/front_file/makassar-terkini/mobile/img/icon/login-username.png", true)?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12 boxOut-username">
                                    <div class="boxFieldUsername">
                                        <input type="password" class="form-control field-boxLeft font-openSans" placeholder="Password" name="data[User][password]">
                                    </div>
                                    <div class="boxIconUsername center flex">
                                        <img src="<?= Router::url("/front_file/makassar-terkini/mobile/img/icon/login-password.png", true)?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12 boxOut-checkBox">
                            <div class="col-md-6 col-sm-6 col-xs-5 box-checkBox">
                                <div class="col-md-12 col-sm-12 col-xs-12 boxCheckBox font-openSans-bold">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-7 box-lupaPassword">
                                <div class="col-md-12 col-sm-12 col-xs-12 font-openSans-bold">
                                    <a href="<?= Router::url("/m/forgot-password", true) ?>">
                                        Lupa password anda?
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12 box-buttonLogin">
                            <button type="submit" class="btn button-login font-openSans-bold">LOGIN</button>
                        </div>
                    </div>
                    <?php echo $this->Form->end(); ?>
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12 box-buttonReset">
                            <button type="button" class="btn button-login font-sourceSansProBold">RESET PASSWORD</button>
                        </div>
                    </div>
                    <div class="row">
