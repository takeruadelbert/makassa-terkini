                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="tab-content">
                                <div id="galleryTab1" class="tab-pane fade in active">
                                    <div id="scrollt1" data-ui="jscroll-default" data-container="#recentNews" data-template="#gallery-video-news-home-nodes" data-order="News.news_date desc" data-limit="3" data-url="<?= Router::url("/fronts/ajax_gallery_videos", true); ?>" data-current-page="1">
                                        <div id="recentNews">
                                            <?php
                                            foreach ($recentNews as $k => $recents) {
                                                ...
                                                if ($k == 0) {
                                                    ?>
                                                    <div class="row">
                                                        <div class="col-md-12 col-sm-12 col-xs-12 boxOut-galleryHeadline" style="background-image: url('<?= str_replace('\\', '/', Router::url($recents['News']['thumbnail_path'], true)) ?>');">
                                                            <div class="row">
                                                                    ...
                                                                    <div class="col-md-12 col-sm-12 col-xs-12 galleryHeadline">
                                                                        <div class="col-md-12 col-sm-12 col-xs-12 box-headlineTitle font-sourceSansPro">
                                                                            <table>
                                                                                <tr>
                                                                                    <td valign="bottom">
                                                                                        <a href="<?= Router::url("/m/video/{$recents['News']['id']}/$recent_photo_news_title") ?>">
                                                            ...
                                                            <div class="gallery-count font-sourceSansProSemibold flex">
                                                                ...
                                                                $getid3 = new getID3;
                                                                $getid3->analyze(WWW_ROOT . ltrim($recents['News']['video_path'], "/"));
                                                    ...
                                                    if ($k % 3 == 0) {
                                                        ...
                                                        <div class="row">
                                                            <?php
                                                            echo $this->element(_FRONT_TEMPLATE_DIR . "/" . $frontTemplate . "/node_iklan_mobile", [ "position" => 1]);
                                                            ?>
                                                        </div>
                                                        <?php
                                                    }
                                ...
                                <div id="galleryTab2" class="tab-pane fade">
                                    <div id="scrollt2" data-ui="jscroll-default" data-container="#popularNews" data-template="#gallery-video-news-home-nodes" data-order="News.popular_rate desc" data-limit="3" data-url="<?= Router::url("/fronts/ajax_gallery_videos", true); ?>" data-current-page="1">
                                        <div id="popularNews">
                                            <?php
                                ...
                                <div id="galleryTab3" class="tab-pane fade">
                                    <div id="scrollt3" data-ui="jscroll-default" data-container="#recommendedNews" data-template="#gallery-video-news-home-nodes" data-order="News.popular_rate desc" data-limit="3" data-url="<?= Router::url("/fronts/ajax_gallery_videos", true); ?>" data-current-page="1">
