                ...
                <div class="col-md-12 col-sm-12 col-xs-12 boxOut-loginTop boxOut-loginUp">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12 box-username">
                            <div class="row ">
                                <div class="col-md-12 col-sm-12 col-xs-12 boxOut-username">
                                    <div class="boxFieldUsername">
                                        <input type="password" class="form-control field-boxLeft font-openSans" placeholder="New Password" name="data[User][password]">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12 boxOut-username">
                                    <div class="boxFieldUsername">
                                        <input type="password" class="form-control field-boxLeft font-openSans" placeholder="Repeat Password" name="data[User][repeat_password]">
                                    </div>
                                    <div class="boxIconUsername center flex">
                                        <img src="<?= Router::url("/front_file/makassar-terkini/mobile/img/icon/login-password.png", true)?>">
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12 box-buttonLogin">
                            <button type="submit" class="btn button-login font-openSans-bold">GANTI PASSWORD</button>
                        </div>
                    </div>
