...
<section class="s-main-content">
    ...
    <div class="s-col-2-per-3 pull-left f-content-area" style="/*background: #123;*/">
        <?php echo $this->element(_FRONT_TEMPLATE_DIR . DS . $frontTemplate . DS . "node_semua_video_populer"); ?>
    ...
    <div class="s-col-1-per-3 pull-right f-extra-area" style="">
        ...
        <?php
        echo $this->element(_FRONT_TEMPLATE_DIR . "/" . $frontTemplate . "/node_iklan", ["type" => 4, "position" => 1, "upperFence" => 0]);
        ?>
    </div>
