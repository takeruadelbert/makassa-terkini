...
<section class="s-main-content">
    ...
    <div class="s-col-2-per-3 pull-left f-content-area" style="/*background: #123;*/">
        <?php echo $this->element(_FRONT_TEMPLATE_DIR . DS . $frontTemplate . DS . "node_pencarian_berita"); ?>
    ...
    <div class="s-col-1-per-3 pull-right f-extra-area" style="">
        ...
        ?>
        <?php echo $this->element(_FRONT_TEMPLATE_DIR . DS . $frontTemplate . DS . "node_berita_pop"); ?><?php
        echo $this->element(_FRONT_TEMPLATE_DIR . "/" . $frontTemplate . "/node_iklan", ["type" => 4, "position" => 1, "idx" => 1]);
        ?>
        <?php echo $this->element(_FRONT_TEMPLATE_DIR . DS . $frontTemplate . DS . "node_event_terkini"); ?><?php
