...
<section class="s-main-content">
    ...
    <div class="s-col-2-per-3 pull-left" style="/*background: #123;*/">
        ...
        <div class="popup-gallery" style="margin-top: 15px; margin-bottom: 15px;">
            <?php
            echo $currentCitizenReport['News']['sinopsys_ind'];
            foreach ($currentCitizenReport['NewsImage'] as $k => $news_images) {
                ?>
                ...
                if ($k % 2 != 0) {
                    ?>
                    <?php
                    if ($currentCitizenReport['NewsCategory']['uniq'] == "news" || $currentCitizenReport['NewsCategory']['parent_id'] == 1) {
                        echo $this->element(_FRONT_TEMPLATE_DIR . "/" . $frontTemplate . "/node_iklan", ["type" => 3, "position" => 11]);
                    } else if ($currentCitizenReport['NewsCategory']['uniq'] == "bisnis" || $currentCitizenReport['NewsCategory']['parent_id'] == 2) {
                        echo $this->element(_FRONT_TEMPLATE_DIR . "/" . $frontTemplate . "/node_iklan", ["type" => 3, "position" => 12]);
                    } else if ($currentCitizenReport['NewsCategory']['uniq'] == "tekno" || $currentCitizenReport['NewsCategory']['parent_id'] == 3) {
                        echo $this->element(_FRONT_TEMPLATE_DIR . "/" . $frontTemplate . "/node_iklan", ["type" => 3, "position" => 13]);
                    } else if ($currentCitizenReport['NewsCategory']['uniq'] == "lifestyle" || $currentCitizenReport['NewsCategory']['parent_id'] == 4) {
                        echo $this->element(_FRONT_TEMPLATE_DIR . "/" . $frontTemplate . "/node_iklan", ["type" => 3, "position" => 14]);
                    } else if ($currentCitizenReport['NewsCategory']['uniq'] == "sport" || $currentCitizenReport['NewsCategory']['parent_id'] == 5) {
                        echo $this->element(_FRONT_TEMPLATE_DIR . "/" . $frontTemplate . "/node_iklan", ["type" => 3, "position" => 15]);
                    } else if ($currentCitizenReport['NewsCategory']['uniq'] == "gallery" || $currentCitizenReport['NewsCategory']['parent_id'] == 6) {
    ...
    <div class="s-col-1-per-3 pull-right" style="">
        <?php
        if ($currentCitizenReport['NewsCategory']['uniq'] == "news" || $currentCitizenReport['NewsCategory']['parent_id'] == 1) {
            echo $this->element(_FRONT_TEMPLATE_DIR . "/" . $frontTemplate . "/node_iklan", ["type" => 4, "position" => 11]);
        } else if ($currentCitizenReport['NewsCategory']['uniq'] == "bisnis" || $currentCitizenReport['NewsCategory']['parent_id'] == 2) {
            echo $this->element(_FRONT_TEMPLATE_DIR . "/" . $frontTemplate . "/node_iklan", ["type" => 4, "position" => 12]);
        } else if ($currentCitizenReport['NewsCategory']['uniq'] == "tekno" || $currentCitizenReport['NewsCategory']['parent_id'] == 3) {
            echo $this->element(_FRONT_TEMPLATE_DIR . "/" . $frontTemplate . "/node_iklan", ["type" => 4, "position" => 13]);
        } else if ($currentCitizenReport['NewsCategory']['uniq'] == "lifestyle" || $currentCitizenReport['NewsCategory']['parent_id'] == 4) {
            echo $this->element(_FRONT_TEMPLATE_DIR . "/" . $frontTemplate . "/node_iklan", ["type" => 4, "position" => 14]);
        } else if ($currentCitizenReport['NewsCategory']['uniq'] == "sport" || $currentCitizenReport['NewsCategory']['parent_id'] == 5) {
            echo $this->element(_FRONT_TEMPLATE_DIR . "/" . $frontTemplate . "/node_iklan", ["type" => 4, "position" => 15]);
        } else if ($currentCitizenReport['NewsCategory']['uniq'] == "gallery" || $currentCitizenReport['NewsCategory']['parent_id'] == 6) {
            echo $this->element(_FRONT_TEMPLATE_DIR . "/" . $frontTemplate . "/node_iklan", ["type" => 4, "position" => 16]);
        }
        ?>
