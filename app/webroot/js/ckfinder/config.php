...
$config['backends'][] = array(
    'name' => 'default',
    'adapter' => 'local',
//    'baseUrl' => "http://localhost/makassar-terkini/",
//    'root' => 'D:/xampp/htdocs/makassar-terkini/app/webroot/', // Can be used to explicitly set the CKFinder user files directory.
    'baseUrl' => $_SESSION['sck']['baseUrl'].$_SESSION['sck']['folder'],
    'root' => $_SESSION['sck']['root'].$_SESSION['sck']['folder'], // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles' => 0777,
    'chmodFolders' => 0755,
